<template>
    <div id="customer">
        ...
        <div class="modal fade" id="customerModalLong" tabindex="-1" role="dialog"
             aria-labelledby="customerModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="customerModalLongTitle">{{ editMode ? " Edit" : "Add New " }}
                            Customer</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form @submit.prevent="editMode ? update() : store()" @keydown="form.onKeydown($event)">
                            ...
                            <div class="form-group">
                                <label>Email</label>
                                <input v-model="form.email" type="email" name="emil"
                                       class="form-control" :class="{ 'is-invalid': form.errors.has('email') }">
                                <has-error :form="form" field="emil"></has-error>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button :disabled="form.busy" type="submit" class="btn btn-primary">Save changes
                                </button>
                            </div>
                        </form>
                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            reload() {
                ...
                this.$snotify.success('Data Successfully Reload', 'Success')
            },
            create() {
                this.editMode = false
                this.form.reset()
